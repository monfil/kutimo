# gr1 = Group.create(name: "Los Mews")

u1 = User.create(name: "Mew", last_name: "Monfil", email: "mew@mail.com", password: "123456")
u2 = User.create(name: "Taki", last_name: "Hernández", email: "taki@mail.com", password: "123456")
u3 = User.create(name: "Viten", last_name: "Monfil", email: "viten@mail.com", password: "123456")
